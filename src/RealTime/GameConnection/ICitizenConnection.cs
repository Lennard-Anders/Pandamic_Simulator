...
namespace RealTime.GameConnection
{
        ...
        where T : struct
    {
        ...
        /// <summary>Sets the specified citizen's death flag value.</summary>
        /// <param name="citizen">The citizen change the death flag of.</param>
        /// <param name="isDead">The flag value.</param>
        void SetDead(ref T citizen, bool isDead);
