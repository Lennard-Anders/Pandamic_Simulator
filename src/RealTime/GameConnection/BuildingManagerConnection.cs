...
namespace RealTime.GameConnection
{
    ...
    internal sealed class BuildingManagerConnection : IBuildingManagerConnection
    {
        ...
        /// <summary>Gets the building's world position.</summary>
        /// <param name="buildingId">The ID of the building.</param>
        /// <returns>The position of the building with the specified ID, or <see cref="Vector3.zero"/> if the ID is invalid.</returns>
        public Vector3 GetBuildingPosition(ushort buildingId) =>
            buildingId == 0
                ? Vector3.zero
                : BuildingManager.instance.m_buildings.m_buffer[buildingId].m_position;
