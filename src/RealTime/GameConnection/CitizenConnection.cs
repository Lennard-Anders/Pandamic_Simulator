...
namespace RealTime.GameConnection
{
    ...
    internal sealed class CitizenConnection : ICitizenConnection<Citizen>
    {
        ...
        public Citizen.AgeGroup GetAge(ref Citizen citizen) => Citizen.GetAgeGroup(citizen.m_age);
        ...
        public Citizen.Wealth GetWealthLevel(ref Citizen citizen) => citizen.WealthLevel;
        ...
        public Citizen.Education GetEducationLevel(ref Citizen citizen) => citizen.EducationLevel;
        ...
        public Citizen.Gender GetGender(uint citizenId) => Citizen.GetGender(citizenId);
        ...
        public Citizen.Happiness GetHappinessLevel(ref Citizen citizen)
            => Citizen.GetHappinessLevel(Citizen.GetHappiness(citizen.m_health, citizen.m_wellbeing));
        ...
        /// </returns>
        public ushort GetCurrentBuilding(ref Citizen citizen) => citizen.GetBuildingByLocation();
        ...
        public ushort GetHomeBuilding(ref Citizen citizen) => citizen.m_homeBuilding;
        ...
        public ushort GetInstance(ref Citizen citizen) => citizen.m_instance;

        /// <summary>Gets the current location type of the specified citizen.</summary>
        /// <param name="citizen">The citizen to get the current location of.</param>
        /// <returns>The citizen's location type.</returns>
        public Citizen.Location GetLocation(ref Citizen citizen) => citizen.CurrentLocation;
        ...
        public ushort GetVehicle(ref Citizen citizen) => citizen.m_vehicle;
        ...
        /// </returns>
        public bool IsArrested(ref Citizen citizen) => citizen.Arrested;
        ...
        /// </returns>
        public bool IsCollapsed(ref Citizen citizen) => citizen.Collapsed;
        ...
        /// </returns>
        public bool IsDead(ref Citizen citizen) => citizen.Dead;

        /// <summary>Sets the specified citizen's dead flag value.</summary>
        /// <param name="citizen">The citizen change the sick flag of.</param>
        /// <param name="isDead">The flag value.</param>
        public void SetDead(ref Citizen citizen, bool isDead) => citizen.Dead = isDead;
        ...
        public void SetArrested(ref Citizen citizen, bool isArrested) => citizen.Arrested = isArrested;
        ...
        public void SetHome(ref Citizen citizen, uint citizenId, ushort buildingId) => citizen.SetHome(citizenId, buildingId, 0u);
