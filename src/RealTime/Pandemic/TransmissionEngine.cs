// <copyright file="TransmissionEngine.cs" company="dymanoid">
...
namespace RealTime.Pandemic
{
    ...
    /// <summary>One source-specific exposure candidate for a susceptible target.</summary>
    internal sealed class TransmissionExposure<TContext>
    {
        ...
        public long StableContextKey { get; set; }

        public TContext Context { get; set; }
    }

    /// <summary>The single attributed source selected after one successful target-level infection draw.</summary>
    internal sealed class ResolvedTransmission<TContext>
    {
        public uint SourceCitizenId { get; set; }
    ...
    internal sealed class TransmissionEngine
    {
